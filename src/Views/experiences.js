      ...
      <div className="container">
        ...
        <div class="row mt-3">
          <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 mt-3 text-center text-white">
            <div className="card">
              ...
              <div className="card-body">
                <h3 className="card-title">{"Portcast, Singapore"}</h3>
                <h6 className="card-text text-dark">{"Software Engineer"}</h6>
                <p className="card-text text-dark text-align-justify">
                  Implemented Typesense search index to improve search
                  functionality and provide faster results. Demonstrated
                  expertise in Vue.js and Flask frameworks to build scalable and
                  responsive user interfaces and backend services.
                </p>
                <p className="align-items-center mt-5 w-100">
                  <span className="ml-2 text-dark">
                    <b className="text-dark">From </b> {"Apr 2021"}{" "}
          ...
          <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 mt-3 text-center text-white">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p className="card-text text-dark text-align-justify">
                  Working on a product Revature Pro-A Training platform for
                  students.In-House Application to track the employees who are
                  completing their probation and notify the HR Team with the
                  employee details.
                </p>
          ...
          <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 mt-3 text-center text-white">
            <div className="card">
              <img
                src={"https://tricog.in/wp-content/uploads/2022/05/logo.png"}
                className="card-img-top mt-3"
                alt="tricog"
                style={{
                  width: "80%",
              ...
              <div className="card-body">
                <h3 className="card-title">
                  {"Tricog Health Services, Bangalore"}
                </h3>
                <h6 className="card-text text-dark">
                  {"Full Stack Web Developer"}
                </h6>
                <p className="card-text text-dark text-align-justify">
                  ...
                  &nbsp; for Managing hardware devices produced by the company,
                  providing OTA Updates, Device Configuration, etc."
                </p>
                <p className="align-items-center mt-5 w-100">
                  <span className="ml-2 text-dark">
          ...
          <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 mt-3 text-center text-white">
            <div className="card">
              ...
              <div className="card-body">
                <h3 className="card-title">
                  {"Sqenta Technologies, Coimbatore"}
                </h3>
                <h6 className="card-text text-dark">
                  {"Full Stack Web Developer"}
                </h6>
                <p className="card-text text-dark text-align-justify">
                  ...
                  Angular 7). This was aimed at colleges to provide a quality
                  assesment tool for their students.
                </p>
          ...
          <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 mt-3 text-center text-white">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p className="card-text text-dark text-align-justify">
                  Got immense experience on computer programming.Worked on many
